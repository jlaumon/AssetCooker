...
void gUIUpdate()
{
	...
	colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(1.000f, 1.000f, 1.000f, 0.391f);
	...
	if (gUIScale.mNeedUpdate)
	{
		...
		//ImGui::GetStyle().FrameBorderSize = ImTrunc(ImGui::GetStyle().FrameBorderSize * gUIScale.GetFinalScale());
		...
		// The main font.
		{
			...
			//io.Fonts->AddFontFromFileTTF("c:\\Windows\\Fonts\\segoeui.ttf", 16.0f * gUIScale.GetFinalScale());
		}
